...
options.category = {
    ...
    {
        name = "グルーヴゲージ",
        myItems = {"グルーヴゲージのフレーム", "グルーヴゲージの種類の文字", "グルーヴゲージのインディケーター", "グルーヴゲージ隠し"}
    },
    {
        name = "カスタムグルーヴゲージ",
    ...
    },
    {
        name = "キービーム",
        myItems = {
            "キービーム長さ", "キービーム出現時間", "キービーム消失時間", "キービーム出現アニメーション", "キービーム消失アニメーション",
    ...
    },
    {
        name = "楽曲詳細表示",
        myItems = {
            "楽曲詳細表示", "楽曲詳細情報のステージファイルオフセット", "楽曲詳細のノーツグラフ種類",
