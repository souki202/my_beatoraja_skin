        ...
        },
        {
            ...
            item = {
                ...
                },
                {
                    TEXT = "スコアグラフ",
                    description = {
                        TEXT = "※プレイスキン併用時のみ使用可能です.\n矢印キー上下でスコアグラフとグルーヴゲージの表示を切り替えることができます."
                    }
                },
            }
        },
