...
local function main()
    ...
    skin.source = {
        ...
        -- AAAからランク毎
        {id = 110, path = "../result/background/ranks/aaa/*", def = "default"},
        {id = 111, path = "../result/background/ranks/aa/*", def = "default"},
        {id = 112, path = "../result/background/ranks/a/*", def = "default"},
        {id = 113, path = "../result/background/ranks/b/*", def = "default"},
        {id = 114, path = "../result/background/ranks/c/*", def = "default"},
        {id = 115, path = "../result/background/ranks/d/*", def = "default"},
        {id = 116, path = "../result/background/ranks/e/*", def = "default"},
        {id = 117, path = "../result/background/ranks/f/*", def = "default"},
        -- {id = 118, path = "../result/background/ranks/f/*.png"},
        -- FAILEDからランプ毎
        {id = 120, path = "../result/background/lamps/failed/*", def = "default"},
        {id = 121, path = "../result/background/lamps/aeasy/*", def = "default"},
        {id = 122, path = "../result/background/lamps/laeasy/*", def = "default"},
        {id = 123, path = "../result/background/lamps/easy/*", def = "default"},
        {id = 124, path = "../result/background/lamps/normal/*", def = "default"},
        {id = 125, path = "../result/background/lamps/hard/*", def = "default"},
        {id = 126, path = "../result/background/lamps/exhard/*", def = "default"},
        {id = 127, path = "../result/background/lamps/fullcombo/*", def = "default"},
        {id = 128, path = "../result/background/lamps/perfect/*", def = "default"},
